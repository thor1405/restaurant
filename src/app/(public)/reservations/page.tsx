          ...
          <AnimatePresence mode="wait">
            {!isSubmitted ? (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full bg-[#1C1C1C] border-b border-white/20 pb-3 text-white focus:outline-none focus:border-(--color-accent) transition-colors appearance-none disabled:opacity-50"
                    >
                  ...
                  {/* Occasion */}
                  <div>
                    <label htmlFor="occasion" className="block text-white/70 text-sm tracking-widest uppercase mb-2">Special Occasion (Optional)</label>
                    <select 
                ...
                {/* Special Requests */}
                <div>
                  <label htmlFor="requests" className="block text-white/70 text-sm tracking-widest uppercase mb-2">Special Requests (Optional)</label>
                  <textarea 
