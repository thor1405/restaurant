    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center mt-20">
        ...
        <motion.h1
          ...
          className="font-heading text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-[#111111] mb-8 leading-tight"
        >
          Artistry in <br />
          <span className="italic font-light text-[#111111]/90">Every Pastry</span>
        </motion.h1>
      ...
      <motion.button
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[#111111]/60 hover:text-(--color-accent) transition-colors flex flex-col items-center gap-2"
      >
